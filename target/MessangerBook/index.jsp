...
$(document).ready(function(){
	...
	$("#add").click(function() {
        ...
        var w3r_JSON = JSON.stringify(w3r).json; // w3r_JSON holds {"PHP":"w3resource PHP tutorial","Examples":500}
		...
		/*  $.ajax({
			...
			url : "http://localhost:8080/MessangerBook/restapi/messages/addUser/test/"+data,
			data: $.getJSON( "data.js", {
				"name" : $('#name').val(),
				"author" : $('#author').val(),
				"message" : $('#message').val(),
				"email" : $("#email").val(),
